            ...
            <Stack direction='row' sx={{ width: { xs: 1, sm: 'auto' }, gap: { xs: 4, md: 8 } }}>
              <Box>
                ...
                <Typography
                  ...
                  sx={{ fontWeight: 400, lineHeight: 1.3, mt: { xs: 2, lg: 0 } }}
                >
              ...
              <Box>
                ...
                <Typography
                  ...
                  sx={{ fontWeight: 400, lineHeight: 1.3, mt: { xs: 2, lg: 0 } }}
                >
                  {formatToThousands(+formatEther(userDebtBal || BigInt(0)))
                    .slice(1)
                    .slice(0, -3)}{' '}
              ...
              <Box sx={{ width: { xs: 16, lg: 25 }, height: { xs: 16, lg: 25 } }}>
                ...
                >
                  <path
                    fill-rule='evenodd'
                    clip-rule='evenodd'
                    d='M12.9693 11.4835C11.3577 11.5181 9.74684 12.0087 8.73353 13.425C7.32979 15.3869 4.57728 19.8037 2.34727 23.3821C1.47062 24.7888 0.674713 26.066 0.0732384 27.0135C-0.0837555 27.2608 0.0206642 27.5848 0.302658 27.6657C2.55994 28.3133 6.82106 28.1117 8.05837 26.2436L15.3897 15.1747C18.0174 19.1337 21.2 23.8158 23.115 26.6114C23.2843 26.8585 23.6362 26.8874 23.8352 26.664C25.6081 24.6743 28.1253 20.7936 26.4496 18.2857L14.3722 0.209082C14.2039 -0.0427856 13.8459 -0.0754662 13.6508 0.15572C11.9567 2.16313 9.73938 6.33895 12.051 10.0392C12.3182 10.467 12.6272 10.9525 12.9693 11.4835Z'
                    fill='#67DAB1'
                  />
                </svg>
              </Box>
              <Typography variant={isSmallScreen ? 'subtitle1' : 'h4'} fontWeight={600}>
                Stake TREN (Coming Soon)
              </Typography>
            </Stack>
            {/* <Stack direction='row' alignItems='center'>
          ...
          >
            <Stack direction='row' sx={{ width: { xs: 1, md: 'auto' }, gap: { xs: 4, md: 8 } }}>
              <Box>
                ...
                <Stack direction='row' alignItems='center'>
                  <Typography variant={isSmallScreen ? 'subtitle1' : 'h5'} sx={{ fontWeight: 400 }} color='primary'>
                    {47}%&nbsp;
                  </Typography>
                  <Icon icon='bi:fire' color={theme.palette.primary.main} fontSize={18} />
                  <Typography
            ...
            <Button
              sx={{ width: { xs: 1, lg: 'auto' }, px: 6, py: 2, color: 'white', fontSize: 18 }}
              variant='outlined'
              color='primary'
            >
              Deposit
