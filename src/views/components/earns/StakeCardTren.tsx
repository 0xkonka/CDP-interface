...
export const StakeCardTren = (props: Props) => {
    ...
    return (
        <Stack position='relative' direction='column' alignItems='center' px={2.5} py={6} borderRadius={1.25} border='solid 1px #FFFFFF33'>
            <Stack position='absolute' zIndex={10} top={0} left={0} sx={{backdropFilter: 'blur(3px)', width: 1, height: 1}} justifyContent='center' alignItems='center'>
