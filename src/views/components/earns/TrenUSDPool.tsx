...
export const TrenUSDPool = () => {
    ...
    return (
        <Box sx={{ ...radiusBoxStyle, py: {xs: 3, md: 10}, background: '#1013149C' }}>
            <Grid container spacing={12}>
                <Grid item xs={12} md={6}>
                    <Stack justifyContent='space-between' height='100%' gap={4}>
                        ...
                        <Stack direction={isMobileScreen ? 'column' : 'row'} justifyContent='space-between' alignItems={isMobileScreen ? 'start' : 'center'} gap={4} mt={4}>
                            <Stack direction='row'sx={{ width: { xs: 1, sm: 'auto' }, gap: { xs: 4, md: 16 } }}>
                                <Box>
                                    <Typography variant={isSmallScreen ? 'subtitle2' : 'subtitle2'} sx={{ mb: 1 }} color='#D4D4D47D' fontWeight={400} >
                        ...
                        <Grid container spacing={4} sx={{mt: {xs: 2, md: 6}}}>
                            <Grid item xs={12} md={4}>
                                <Stack direction='column' alignItems='center' px={2.5} py={5} borderRadius={1.25} border='solid 1px #FFFFFF33' sx={{backgroundColor: '#101314'}}>
