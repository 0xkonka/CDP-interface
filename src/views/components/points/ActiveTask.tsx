...
export const ActiveTask = (props: Props) => {
    ...
    return (
        <Stack padding={4} borderRadius='10px' bgcolor='#171717' height='100%' justifyContent='space-between'>
            ...
            <Typography variant='subtitle1' color='#C6C6C7' lineHeight={1.25} height={80}>{description}</Typography>
            <Stack borderTop='solid 1px #C6C6C74D'>
                <Stack mt={3} direction='row' justifyContent='space-between' height={20}>
