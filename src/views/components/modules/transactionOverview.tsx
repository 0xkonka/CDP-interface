...
export const TransactionOverView = (props: Props) => {
    ...
    const {healthFrom, healthTo, liquidationPrice, gasFee, uptoFee, type, debt} = props
            ...
            <Stack sx={radiusBoxStyle} gap={6}>
                {
                    ...
                    <Stack direction='row' justifyContent='space-between' alignItems='center'>
                        ...
                        <Stack direction='row' gap={3} alignItems='center'>
                            ...
                            <Stack direction='row' gap={1} alignItems='end'>
                                <Typography variant='h5' color='#67DAB1'>{formatToThousands(debt-10).substring(1)}</Typography>
                                <Typography variant='body2' color='#FFF'>trenUSD</Typography>
                            </Stack>
                        </Stack>
                    </Stack>
