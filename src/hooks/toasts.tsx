...
return (
  <Stack direction='row' sx={{
    ...
    <Icon icon='mdi:error' fontSize={isSmallScreen ? 36 : 40}/>
    <Box>
      <Typography sx={{mb: 1, fontSize: {xs: 18, md: 22}, fontWeight: 500}}>{header}</Typography>
...
return (
    <Stack direction='row' sx={{
      ...
      <Icon icon='mdi:success-circle' fontSize={isSmallScreen ? 36 : 40}/>
      <Box>
        <Typography variant='h4' sx={{mb: 1, fontSize: {xs: 18, md: 22}, fontWeight: 500}}>{header}</Typography>
        <Typography variant='subtitle1'>{content}</Typography>
        {
          hyperLink != '#' &&
