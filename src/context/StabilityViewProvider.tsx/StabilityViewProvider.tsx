...
import { LiquityStoreState, StabilityDeposit } from '@/lib-base'
import { StabilityViewContext } from './StabilityViewContext'
import type { StabilityView, StabilityEvent } from './types'

type StabilityEventTransitions = Record<StabilityView, Partial<Record<StabilityEvent, StabilityView>>>
...
export const StabilityViewProvider: React.FC<StabilityViewProviderProps> = ({ children }) => {
