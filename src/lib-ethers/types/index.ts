...
import { _TypedTrenContract, _TypedLogDescription } from "../src/contracts";
...
interface ActivePoolCalls {
  ...
  getTrenUSDDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  stabilityPoolAddress(_overrides?: CallOverrides): Promise<string>;
  moduleManagerAddress(_overrides?: CallOverrides): Promise<string>;
}

interface ActivePoolTransactions {
  decreaseTrenUSDDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  increaseTrenUSDDebt(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  sendETH(_account: string, _amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  setAddresses(_borrowerOperationsAddress: string, _moduleManagerAddress: string, _stabilityPoolAddress: string, _defaultPoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface ActivePool
  extends _TypedTrenContract<ActivePoolCalls, ActivePoolTransactions> {
  readonly filters: {
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    ActivePoolETHBalanceUpdated(_ETH?: null): EventFilter;
    ActivePoolTrenUSDDebtUpdated(_TrenUSDDebt?: null): EventFilter;
    ...
    TrenUSDBalanceUpdated(_newBalance?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    StabilityPoolAddressChanged(_newStabilityPoolAddress?: null): EventFilter;
    ModuleManagerAddressChanged(_newModuleManagerAddress?: null): EventFilter;
  };
  ...
  extractEvents(logs: Log[], name: "ActivePoolTrenUSDDebtUpdated"): _TypedLogDescription<{ _TrenUSDDebt: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "TrenUSDBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "ModuleManagerAddressChanged"): _TypedLogDescription<{ _newModuleManagerAddress: string }>[];
}
...
interface BorrowerOperationsCalls {
  ...
  TrenUSD_GAS_COMPENSATION(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  trenUSDToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedModules(_overrides?: CallOverrides): Promise<string>;
  moduleManager(_overrides?: CallOverrides): Promise<string>;
}
...
interface BorrowerOperationsTransactions {
  ...
  adjustModule(_maxFeePercentage: BigNumberish, _collWithdrawal: BigNumberish, _TrenUSDChange: BigNumberish, _isDebtIncrease: boolean, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  claimCollateral(_overrides?: Overrides): Promise<void>;
  closeModule(_overrides?: Overrides): Promise<void>;
  moveETHGainToModule(_borrower: string, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  openModule(_maxFeePercentage: BigNumberish, _TrenUSDAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: PayableOverrides): Promise<void>;
  repayTrenUSD(_TrenUSDAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_moduleManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _sortedModulesAddress: string, _trenUSDTokenAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawColl(_collWithdrawal: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  withdrawTrenUSD(_maxFeePercentage: BigNumberish, _TrenUSDAmount: BigNumberish, _upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
}

export interface BorrowerOperations
  extends _TypedTrenContract<BorrowerOperationsCalls, BorrowerOperationsTransactions> {
  readonly filters: {
    ...
    TrenUSDBorrowingFeePaid(_borrower?: string | null, _TrenUSDFee?: null): EventFilter;
    TrenUSDTokenAddressChanged(_trenUSDTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    SortedModulesAddressChanged(_sortedModulesAddress?: null): EventFilter;
    StabilityPoolAddressChanged(_stabilityPoolAddress?: null): EventFilter;
    ModuleCreated(_borrower?: string | null, arrayIndex?: null): EventFilter;
    ModuleManagerAddressChanged(_newModuleManagerAddress?: null): EventFilter;
    ModuleUpdated(_borrower?: string | null, _debt?: null, _coll?: null, stake?: null, operation?: null): EventFilter;
  };
  ...
  extractEvents(logs: Log[], name: "TrenUSDBorrowingFeePaid"): _TypedLogDescription<{ _borrower: string; _TrenUSDFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "TrenUSDTokenAddressChanged"): _TypedLogDescription<{ _trenUSDTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "SortedModulesAddressChanged"): _TypedLogDescription<{ _sortedModulesAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "ModuleCreated"): _TypedLogDescription<{ _borrower: string; arrayIndex: BigNumber }>[];
  extractEvents(logs: Log[], name: "ModuleManagerAddressChanged"): _TypedLogDescription<{ _newModuleManagerAddress: string }>[];
  extractEvents(logs: Log[], name: "ModuleUpdated"): _TypedLogDescription<{ _borrower: string; _debt: BigNumber; _coll: BigNumber; stake: BigNumber; operation: number }>[];
}
...
interface CollSurplusPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _moduleManagerAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface CollSurplusPool
  extends _TypedTrenContract<CollSurplusPoolCalls, CollSurplusPoolTransactions> {
  readonly filters: {
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
...
export interface CommunityIssuance
  extends _TypedTrenContract<CommunityIssuanceCalls> {
  readonly filters: {
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
...
interface DefaultPoolTransactions {
  ...
  setAddresses(_moduleManagerAddress: string, _activePoolAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface DefaultPool
  extends _TypedTrenContract<DefaultPoolCalls, DefaultPoolTransactions> {
  readonly filters: {
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    DefaultPoolAddressChanged(_newDefaultPoolAddress?: null): EventFilter;
    DefaultPoolETHBalanceUpdated(_ETH?: null): EventFilter;
    DefaultPoolTrenUSDDebtUpdated(_TrenUSDDebt?: null): EventFilter;
    ETHBalanceUpdated(_newBalance?: null): EventFilter;
    EtherSent(_to?: null, _amount?: null): EventFilter;
    TrenUSDBalanceUpdated(_newBalance?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "DefaultPoolTrenUSDDebtUpdated"): _TypedLogDescription<{ _TrenUSDDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "ETHBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "EtherSent"): _TypedLogDescription<{ _to: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "TrenUSDBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
...
export interface ERC20Mock
  extends _TypedTrenContract<ERC20MockCalls, ERC20MockTransactions> {
  readonly filters: {
...
export interface GasPool
  extends _TypedTrenContract<GasPoolCalls, GasPoolTransactions> {
  readonly filters: {
  };
}
...
interface HintHelpersCalls {
  ...
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getRedemptionHints(_TrenUSDamount: BigNumberish, _price: BigNumberish, _maxIterations: BigNumberish, _overrides?: CallOverrides): Promise<{ firstRedemptionHint: string; partialRedemptionHintNICR: BigNumber; truncatedTrenUSDamount: BigNumber }>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedModules(_overrides?: CallOverrides): Promise<string>;
...
interface HintHelpersTransactions {
  setAddresses(_sortedModulesAddress: string, _moduleManagerAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface HintHelpers
  extends _TypedTrenContract<HintHelpersCalls, HintHelpersTransactions> {
  readonly filters: {
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    SortedModulesAddressChanged(_sortedModulesAddress?: null): EventFilter;
    ModuleManagerAddressChanged(_moduleManagerAddress?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "SortedModulesAddressChanged"): _TypedLogDescription<{ _sortedModulesAddress: string }>[];
  extractEvents(logs: Log[], name: "ModuleManagerAddressChanged"): _TypedLogDescription<{ _moduleManagerAddress: string }>[];
}
...
export interface IERC20
  extends _TypedTrenContract<IERC20Calls, IERC20Transactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    Transfer(from?: string | null, to?: string | null, value?: null): EventFilter;
  };
...
export interface LockupContractFactory
  extends _TypedTrenContract<LockupContractFactoryCalls, LockupContractFactoryTransactions> {
  readonly filters: {
...
interface TrenUSDTokenTransactions {
  approve(spender: string, amount: BigNumberish, _overrides?: Overrides): Promise<boolean>;
...
export interface TrenUSDToken
  extends _TypedTrenContract<TrenUSDTokenCalls, TrenUSDTokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
    TrenUSDTokenBalanceUpdated(_user?: null, _amount?: null): EventFilter;
    StabilityPoolAddressChanged(_newStabilityPoolAddress?: null): EventFilter;
    Transfer(from?: string | null, to?: string | null, value?: null): EventFilter;
    ModuleManagerAddressChanged(_moduleManagerAddress?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "Approval"): _TypedLogDescription<{ owner: string; spender: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "BorrowerOperationsAddressChanged"): _TypedLogDescription<{ _newBorrowerOperationsAddress: string }>[];
  extractEvents(logs: Log[], name: "TrenUSDTokenBalanceUpdated"): _TypedLogDescription<{ _user: string; _amount: BigNumber }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _newStabilityPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "Transfer"): _TypedLogDescription<{ from: string; to: string; value: BigNumber }>[];
  extractEvents(logs: Log[], name: "ModuleManagerAddressChanged"): _TypedLogDescription<{ _moduleManagerAddress: string }>[];
}

interface MultiModuleGetterCalls {
  getMultipleSortedModules(_startIdx: BigNumberish, _count: BigNumberish, _overrides?: CallOverrides): Promise<{ owner: string; debt: BigNumber; coll: BigNumber; stake: BigNumber; snapshotETH: BigNumber; snapshotTrenUSDDebt: BigNumber }[]>;
  sortedModules(_overrides?: CallOverrides): Promise<string>;
  moduleManager(_overrides?: CallOverrides): Promise<string>;
}

interface MultiModuleGetterTransactions {
}

export interface MultiModuleGetter
  extends _TypedTrenContract<MultiModuleGetterCalls, MultiModuleGetterTransactions> {
  readonly filters: {
  };
}
...
export interface PriceFeed
  extends _TypedTrenContract<PriceFeedCalls, PriceFeedTransactions> {
  readonly filters: {
...
export interface PriceFeedTestnet
  extends _TypedTrenContract<PriceFeedTestnetCalls, PriceFeedTestnetTransactions> {
  readonly filters: {
    LastGoodPriceUpdated(_lastGoodPrice?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "LastGoodPriceUpdated"): _TypedLogDescription<{ _lastGoodPrice: BigNumber }>[];
...
interface SortedModulesTransactions {
  ...
  setParams(_size: BigNumberish, _moduleManagerAddress: string, _borrowerOperationsAddress: string, _overrides?: Overrides): Promise<void>;
}

export interface SortedModules
  extends _TypedTrenContract<SortedModulesCalls, SortedModulesTransactions> {
  readonly filters: {
    ...
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    SortedModulesAddressChanged(_sortedDoublyLLAddress?: null): EventFilter;
    ModuleManagerAddressChanged(_moduleManagerAddress?: null): EventFilter;
  };
  ...
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "SortedModulesAddressChanged"): _TypedLogDescription<{ _sortedDoublyLLAddress: string }>[];
  extractEvents(logs: Log[], name: "ModuleManagerAddressChanged"): _TypedLogDescription<{ _moduleManagerAddress: string }>[];
}
...
interface StabilityPoolCalls {
  ...
  getCompoundedTrenUSDDeposit(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getDepositorETHGain(_depositor: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getETH(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  getTotalTrenUSDDeposits(_overrides?: CallOverrides): Promise<BigNumber>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
  lastETHError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  lastTrenUSDLossError_Offset(_overrides?: CallOverrides): Promise<BigNumber>;
  trenUSDToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  sortedModules(_overrides?: CallOverrides): Promise<string>;
...
interface StabilityPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _moduleManagerAddress: string, _activePoolAddress: string, _trenUSDTokenAddress: string, _sortedModulesAddress: string, _priceFeedAddress: string, _communityIssuanceAddress: string, _overrides?: Overrides): Promise<void>;
  withdrawETHGainToModule(_upperHint: string, _lowerHint: string, _overrides?: Overrides): Promise<void>;
  withdrawFromSP(_amount: BigNumberish, _overrides?: Overrides): Promise<void>;
}

export interface StabilityPool
  extends _TypedTrenContract<StabilityPoolCalls, StabilityPoolTransactions> {
  readonly filters: {
    ActivePoolAddressChanged(_newActivePoolAddress?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
    ...
    ETHGainWithdrawn(_depositor?: string | null, _ETH?: null, _TrenUSDLoss?: null): EventFilter;
    ...
    TrenUSDTokenAddressChanged(_newTrenUSDTokenAddress?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    ...
    SortedModulesAddressChanged(_newSortedModulesAddress?: null): EventFilter;
    StabilityPoolETHBalanceUpdated(_newBalance?: null): EventFilter;
    StabilityPoolTrenUSDBalanceUpdated(_newBalance?: null): EventFilter;
    ModuleManagerAddressChanged(_newModuleManagerAddress?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "ETHGainWithdrawn"): _TypedLogDescription<{ _depositor: string; _ETH: BigNumber; _TrenUSDLoss: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "TrenUSDTokenAddressChanged"): _TypedLogDescription<{ _newTrenUSDTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  ...
  extractEvents(logs: Log[], name: "SortedModulesAddressChanged"): _TypedLogDescription<{ _newSortedModulesAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolETHBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "StabilityPoolTrenUSDBalanceUpdated"): _TypedLogDescription<{ _newBalance: BigNumber }>[];
  extractEvents(logs: Log[], name: "ModuleManagerAddressChanged"): _TypedLogDescription<{ _newModuleManagerAddress: string }>[];
  extractEvents(logs: Log[], name: "UserDepositChanged"): _TypedLogDescription<{ _depositor: string; _newDeposit: BigNumber }>[];
}

interface ModuleManagerCalls {
  ...
  L_TrenUSDDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  SECONDS_IN_ONE_MINUTE(_overrides?: CallOverrides): Promise<BigNumber>;
  ModuleOwners(arg0: BigNumberish, _overrides?: CallOverrides): Promise<string>;
  Modules(arg0: string, _overrides?: CallOverrides): Promise<{ debt: BigNumber; coll: BigNumber; stake: BigNumber; status: number; arrayIndex: BigNumber }>;
  _100pct(_overrides?: CallOverrides): Promise<BigNumber>;
  activePool(_overrides?: CallOverrides): Promise<string>;
  ...
  defaultPool(_overrides?: CallOverrides): Promise<string>;
  getBorrowingFee(_TrenUSDDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  getBorrowingFeeWithDecay(_TrenUSDDebt: BigNumberish, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getEntireDebtAndColl(_borrower: string, _overrides?: CallOverrides): Promise<{ debt: BigNumber; coll: BigNumber; pendingTrenUSDDebtReward: BigNumber; pendingETHReward: BigNumber }>;
  getEntireSystemColl(_overrides?: CallOverrides): Promise<BigNumber>;
  getEntireSystemDebt(_overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getPendingTrenUSDDebtReward(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getModuleColl(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getModuleDebt(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getModuleFromModuleOwnersArray(_index: BigNumberish, _overrides?: CallOverrides): Promise<string>;
  getModuleOwnersCount(_overrides?: CallOverrides): Promise<BigNumber>;
  getModuleStake(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  getModuleStatus(_borrower: string, _overrides?: CallOverrides): Promise<BigNumber>;
  ...
  lastTrenUSDDebtError_Redistribution(_overrides?: CallOverrides): Promise<BigNumber>;
  trenUSDToken(_overrides?: CallOverrides): Promise<string>;
  owner(_overrides?: CallOverrides): Promise<string>;
  priceFeed(_overrides?: CallOverrides): Promise<string>;
  rewardSnapshots(arg0: string, _overrides?: CallOverrides): Promise<{ ETH: BigNumber; TrenUSDDebt: BigNumber }>;
  sortedModules(_overrides?: CallOverrides): Promise<string>;
...
interface ModuleManagerTransactions {
  addModuleOwnerToArray(_borrower: string, _overrides?: Overrides): Promise<BigNumber>;
  applyPendingRewards(_borrower: string, _overrides?: Overrides): Promise<void>;
  batchLiquidateModules(_moduleArray: string[], _overrides?: Overrides): Promise<void>;
  closeModule(_borrower: string, _overrides?: Overrides): Promise<void>;
  decayBaseRateFromBorrowing(_overrides?: Overrides): Promise<void>;
  decreaseModuleColl(_borrower: string, _collDecrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  decreaseModuleDebt(_borrower: string, _debtDecrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  increaseModuleColl(_borrower: string, _collIncrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  increaseModuleDebt(_borrower: string, _debtIncrease: BigNumberish, _overrides?: Overrides): Promise<BigNumber>;
  liquidate(_borrower: string, _overrides?: Overrides): Promise<void>;
  liquidateModules(_n: BigNumberish, _overrides?: Overrides): Promise<void>;
  redeemCollateral(_TrenUSDamount: BigNumberish, _firstRedemptionHint: string, _upperPartialRedemptionHint: string, _lowerPartialRedemptionHint: string, _partialRedemptionHintNICR: BigNumberish, _maxIterations: BigNumberish, _maxFeePercentage: BigNumberish, _overrides?: Overrides): Promise<void>;
  removeStake(_borrower: string, _overrides?: Overrides): Promise<void>;
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _priceFeedAddress: string, _trenUSDTokenAddress: string, _sortedModulesAddress: string, _overrides?: Overrides): Promise<void>;
  setModuleStatus(_borrower: string, _num: BigNumberish, _overrides?: Overrides): Promise<void>;
  updateStakeAndTotalStakes(_borrower: string, _overrides?: Overrides): Promise<BigNumber>;
  updateModuleRewardSnapshots(_borrower: string, _overrides?: Overrides): Promise<void>;
}

export interface ModuleManager
  extends _TypedTrenContract<ModuleManagerCalls, ModuleManagerTransactions> {
  readonly filters: {
    ActivePoolAddressChanged(_activePoolAddress?: null): EventFilter;
    ...
    DefaultPoolAddressChanged(_defaultPoolAddress?: null): EventFilter;
    GasPoolAddressChanged(_gasPoolAddress?: null): EventFilter;
    LTermsUpdated(_L_ETH?: null, _L_TrenUSDDebt?: null): EventFilter;
    TrenUSDTokenAddressChanged(_newTrenUSDTokenAddress?: null): EventFilter;
    LastFeeOpTimeUpdated(_lastFeeOpTime?: null): EventFilter;
    Liquidation(_liquidatedDebt?: null, _liquidatedColl?: null, _collGasCompensation?: null, _TrenUSDGasCompensation?: null): EventFilter;
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PriceFeedAddressChanged(_newPriceFeedAddress?: null): EventFilter;
    Redemption(_attemptedTrenUSDAmount?: null, _actualTrenUSDAmount?: null, _ETHSent?: null, _ETHFee?: null): EventFilter;
    SortedModulesAddressChanged(_sortedModulesAddress?: null): EventFilter;
    StabilityPoolAddressChanged(_stabilityPoolAddress?: null): EventFilter;
    ...
    ModuleIndexUpdated(_borrower?: null, _newIndex?: null): EventFilter;
    ModuleLiquidated(_borrower?: string | null, _debt?: null, _coll?: null, _operation?: null): EventFilter;
    ModuleSnapshotsUpdated(_L_ETH?: null, _L_TrenUSDDebt?: null): EventFilter;
    ModuleUpdated(_borrower?: string | null, _debt?: null, _coll?: null, _stake?: null, _operation?: null): EventFilter;
  };
  extractEvents(logs: Log[], name: "ActivePoolAddressChanged"): _TypedLogDescription<{ _activePoolAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "DefaultPoolAddressChanged"): _TypedLogDescription<{ _defaultPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "GasPoolAddressChanged"): _TypedLogDescription<{ _gasPoolAddress: string }>[];
  extractEvents(logs: Log[], name: "LTermsUpdated"): _TypedLogDescription<{ _L_ETH: BigNumber; _L_TrenUSDDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "TrenUSDTokenAddressChanged"): _TypedLogDescription<{ _newTrenUSDTokenAddress: string }>[];
  extractEvents(logs: Log[], name: "LastFeeOpTimeUpdated"): _TypedLogDescription<{ _lastFeeOpTime: BigNumber }>[];
  extractEvents(logs: Log[], name: "Liquidation"): _TypedLogDescription<{ _liquidatedDebt: BigNumber; _liquidatedColl: BigNumber; _collGasCompensation: BigNumber; _TrenUSDGasCompensation: BigNumber }>[];
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PriceFeedAddressChanged"): _TypedLogDescription<{ _newPriceFeedAddress: string }>[];
  extractEvents(logs: Log[], name: "Redemption"): _TypedLogDescription<{ _attemptedTrenUSDAmount: BigNumber; _actualTrenUSDAmount: BigNumber; _ETHSent: BigNumber; _ETHFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "SortedModulesAddressChanged"): _TypedLogDescription<{ _sortedModulesAddress: string }>[];
  extractEvents(logs: Log[], name: "StabilityPoolAddressChanged"): _TypedLogDescription<{ _stabilityPoolAddress: string }>[];
  ...
  extractEvents(logs: Log[], name: "ModuleIndexUpdated"): _TypedLogDescription<{ _borrower: string; _newIndex: BigNumber }>[];
  extractEvents(logs: Log[], name: "ModuleLiquidated"): _TypedLogDescription<{ _borrower: string; _debt: BigNumber; _coll: BigNumber; _operation: number }>[];
  extractEvents(logs: Log[], name: "ModuleSnapshotsUpdated"): _TypedLogDescription<{ _L_ETH: BigNumber; _L_TrenUSDDebt: BigNumber }>[];
  extractEvents(logs: Log[], name: "ModuleUpdated"): _TypedLogDescription<{ _borrower: string; _debt: BigNumber; _coll: BigNumber; _stake: BigNumber; _operation: number }>[];
}
...
export interface Unipool
  extends _TypedTrenContract<UnipoolCalls, UnipoolTransactions> {
  readonly filters: {
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
