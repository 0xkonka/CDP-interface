...
import { _TrenContracts, _TypedTrenContract } from "./contracts";

type ContractLookup = {
  [name: string]: _TypedTrenContract;
};
...
export const logsToString = (receipt: TransactionReceipt, contracts: _TrenContracts): string => {
