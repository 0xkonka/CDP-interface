...
const SocialsDropdown = (props: Props) => {
  // ** Props
  ...
  return (
    <Fragment>
      <IconButton color='inherit' aria-haspopup='true' onClick={handleDropdownOpen} aria-controls='customized-menu'>
        <Icon fontSize='1.625rem' icon='tabler:layout-grid' />
      </IconButton>
      <Menu
        anchorEl={anchorEl}
      ...
      >
        ...
        >
          ...
          >
            <Typography variant='h5'>Social Community</Typography>
          </Box>
        </MenuItem>
          ...
          >
            {shortcuts.map(shortcut => (
              ...
              >
                ...
                >
                  <Avatar sx={{ mb: 2, width: 48, height: 48, background: theme => theme.palette.secondary.main }}>
                    <Image src={`/images/icons/social-icons/${shortcut.icon}.svg`}
                      alt='LinkedIn'
                      width={32}
                      height={32}
                    />
